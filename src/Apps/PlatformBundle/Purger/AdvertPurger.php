...
namespace Apps\PlatformBundle\Purger;
...
class AdvertPurger{
  ...
  {
    $advertRepository      = $this->em->getRepository('AppsPlatformBundle:Advert');
    $advertSkillRepository = $this->em->getRepository('AppsPlatformBundle:AdvertSkill');
